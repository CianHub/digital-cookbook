...
from functions import get_pages, generate_pagination_links. get
...
def edit_recipe(recipe_id):
    ...
    return render_template('edit_recipe.html', recipe=the_recipe,  countries=countries)
...
def view_recipe(recipe_id):
    ...
    the_recipe = mongo.db.recipes.find_one({"r":ObjectId(recipe_id)})
